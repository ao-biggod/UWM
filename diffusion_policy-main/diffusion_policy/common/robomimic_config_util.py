...
def _import_robomimic():
    ...
    return config_factory, gpc, modify_config_for_default_image_exp, modify_config_for_default_low_dim_exp, modify_config_for_dataset
...
def get_robomimic_config(
    ...
    config_factory, gpc, modify_config_for_default_image_exp, modify_config_for_default_low_dim_exp, modify_config_for_dataset = _import_robomimic()
